...
#	config.usage.inactivity_timer_blocktime_begin = ConfigClock(default = time.localtime(int(time.mktime((0, 0, 0, 18, 0, 0, 0, 0, 0)))))
	stime = time.time()
	t = time.localtime(stime)
	config.usage.inactivity_timer_blocktime_begin = ConfigClock(default =  time.mktime((t[0],t[1],t[2],18,0,0,t[6],t[7],t[8])))
	config.usage.inactivity_timer_blocktime_end = ConfigClock(default =  time.mktime((t[0],t[1],t[2],23,0,0,t[6],t[7],t[8])))
	config.usage.inactivity_timer_blocktime_extra = ConfigYesNo(default = False)
	config.usage.inactivity_timer_blocktime_extra_begin = ConfigClock(default =  time.mktime((t[0],t[1],t[2],6,0,0,t[6],t[7],t[8])))
	config.usage.inactivity_timer_blocktime_extra_end = ConfigClock(default =  time.mktime((t[0],t[1],t[2],9,0,0,t[6],t[7],t[8])))
	...
	for i in range(7):
		...
		config.usage.inactivity_timer_blocktime_extra_begin_day[i] = ConfigClock(default =  time.mktime((t[0],t[1],t[2],6,0,0,t[6],t[7],t[8])))
	...
	config.usage.standby_to_shutdown_timer_blocktime_begin = ConfigClock(default =  time.mktime((t[0],t[1],t[2],6,0,0,t[6],t[7],t[8])))
	config.usage.standby_to_shutdown_timer_blocktime_end = ConfigClock(default =  time.mktime((t[0],t[1],t[2],23,0,0,t[6],t[7],t[8])))
