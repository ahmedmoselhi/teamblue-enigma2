...
SPACE = "SPACEICON"  # Symbol to be used for a SPACE on the keyboard.  Must be u"SPACE" (any case), u"SPACEICON" or u"SPACEICONALT".
		...
		self.locales = {
			...
			"cs_CZ": [_("Czech"), _("Czechia"), [
				[
					...
					["FIRST", "q", "w", "e", "r", "t", "z", "u", "i", "o", "p", "\u00FA", ")", ""],
					["LAST", "a", "s", "d", "f", "g", "h", "j", "k", "l", "\u016F", "\u00A7", "", "ENTER"],
					["SHIFT", "y", "x", "c", "v", "b", "n", "m", ",", ".", "-", "\u0148", "", "SHIFT"],
					["EXIT", "LOC", "LEFT", "RIGHT", "LongL__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongR__SPACE__HIDE", "ALL", "CLR", "DEL"]
				], [
					[".", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "%", "", "BACKSPACE"],
					["FIRST", "Q", "W", "E", "R", "T", "Z", "U", "I", "O", "P", "/", "(", ""],
					["LAST", "A", "S", "D", "F", "G", "H", "J", "K", "L", "\"", "!", "'", "ENTER"],
					["SHIFT", "Y", "X", "C", "V", "B", "N", "M", "?", ":", "_", "\u0147", "", "SHIFT"],
					["EXIT", "LOC", "LEFT", "RIGHT", "LongL__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongR__SPACE__HIDE", "ALL", "CLR", "DEL"]
				], [
					["", "~", "\u011A", "\u0160", "\u010C", "\u0158", "\u017D", "\u00DD", "\u00C1", "\u00CD", "\u00C9", "`", "", "BACKSPACE"],
					["FIRST", "\\", "|", "\u20AC", "\u0165", "\u0164", "", "", "", "\u00F3", "\u00D3", "\u00DA", "\u00F7", "\u00D7"],
					["LAST", "", "\u0111", "\u00D0", "[", "]", "\u010F", "\u010E", "\u0142", "\u0141", "\u016E", "$", "\u00DF", "ENTER"],
					["SHIFT", "", "#", "&", "@", "{", "}", "", "<", ">", "*", "", "\u00A4", "SHIFT"],
					["EXIT", "LOC", "LEFT", "RIGHT", "LongL__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongM__SPACE__HIDE", "LongR__SPACE__HIDE", "ALL", "CLR", "DEL"]
				]
			]],
