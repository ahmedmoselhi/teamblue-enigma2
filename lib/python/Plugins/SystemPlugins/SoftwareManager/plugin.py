...
from Tools.Directories import resolveFilename, SCOPE_PLUGINS, SCOPE_CURRENT_PLUGIN, SCOPE_CURRENT_SKIN, SCOPE_METADIR, pathExists, fileExists
...
class UpdatePluginMenu(Screen):
	...
	def __init__(self, session, args = 0):
		...
		if self.menu == 0:
			...
			# self.list.append(("plugin-restore",_("Restore Plugins"), _("Restore your previously installed plugins." ) + self.oktext, None))
